...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('plateBonForm');
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('/impact/submit-plate-bon', {
                method: 'POST',
            ...
            if (response.ok) {
                showToast(
                    result.message || 'Request plate bon berhasil dikirim!', 
                    'success'
                );
                form.reset();
...
function validateForm() {
    const requiredFields = document.querySelectorAll('#plateBonForm [required]');
    let isValid = true;
...
function clearValidationStates() {
    const fields = document.querySelectorAll('#plateBonForm .form-control, #plateBonForm .form-select');
...
function setSubmitLoading(loading) {
    const submitButton = document.querySelector('#plateBonForm button[type="submit"]');
