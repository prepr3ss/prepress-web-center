...
def export_kpi_ctp():
    try:
        ...
        headers = [
            ...
            'Cyan 20%', 'Cyan 25%', 'Cyan 50%', 'Cyan 80%', 'Cyan 75%',
            'Magenta 20%', 'Magenta 25%', 'Magenta 50%', 'Magenta 80%', 'Magenta 75%',
            'Yellow 20%', 'Yellow 25%', 'Yellow 50%', 'Yellow 80%', 'Yellow 75%',
            'Black 20%', 'Black 25%', 'Black 50%', 'Black 80%', 'Black 75%',
            'Spot Color 1 20%', 'Spot Color 1 25%', 'Spot Color 1 50%', 'Spot Color 1 80%', 'Spot Color 1 75%',
            'Spot Color 2 20%', 'Spot Color 2 25%', 'Spot Color 2 50%', 'Spot Color 2 80%', 'Spot Color 2 75%',
            'Spot Color 3 20%', 'Spot Color 3 25%', 'Spot Color 3 50%', 'Spot Color 3 80%', 'Spot Color 3 75%',
            'Spot Color 4 20%', 'Spot Color 4 25%', 'Spot Color 4 50%', 'Spot Color 4 80%', 'Spot Color 4 75%',
            'Spot Color 5 20%', 'Spot Color 5 25%', 'Spot Color 5 50%', 'Spot Color 5 80%', 'Spot Color 5 75%',
            'Spot Color 6 20%', 'Spot Color 6 25%', 'Spot Color 6 50%', 'Spot Color 6 80%', 'Spot Color 6 75%',
            'Spot Color 7 20%', 'Spot Color 7 25%', 'Spot Color 7 50%', 'Spot Color 7 80%', 'Spot Color 7 75%',
            'Spot Color 8 20%', 'Spot Color 8 25%', 'Spot Color 8 50%', 'Spot Color 8 80%', 'Spot Color 8 75%',
